...
public interface UserDao extends GenericDao<UserVO, String>{
	...
	public int updatePw(@Param("u_pw") String u_pw,@Param("us_pw") String us_pw, @Param("u_id")String u_id);
	
	public UserVO findByPw(@Param("u_pw")String u_pw, @Param("u_id")String u_id);
	...
	public int deleteByAdmin(UserVO userVO);
	public int ban(UserVO userVO);
}